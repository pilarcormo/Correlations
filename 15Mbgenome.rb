...
hm_r = 'hm <- rnorm(15000, 7500000, 1000)' # Causative SNP at/near 10000
ht_r = 'ht <- runif(15000, 1, 15000000)'   # Genome length of 10000
...
small_genome = arabidopsis_c4[-15000000..-1] # Genome length of 100 kb
contig_size = 7500 # 100-200 bp
